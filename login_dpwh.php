...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!verify_csrf($csrfToken)) {
        ...
        if ($user) {
            if ($user['role'] !== 'dpwh') {
                $error = 'Invalid credentials for DPWH login.';
            } else {
    ...
    <main class="auth-page">
        ...
        <div class="auth-card">
            <div class="role-tabs" role="tablist" aria-label="Login role">
                ...
                <a class="role-tab" type="button" role="tab" href="<?= e(url('login_nurse.php')) ?>" aria-selected="false">Nurse</a>
                <a class="role-tab" type="button" role="tab" href="<?= e(url('login_dpwh.php')) ?>" aria-selected="true">DPWH</a>
            </div>
            ...
            <div class="auth-header">
                ...
                <h2 class="auth-header-title">DPWH Login</h2>
                <p class="auth-header-subtitle">Sign in with your DPWH account.</p>
            </div>
            ...
            <div class="auth-body">
                ...
                <form method="POST" action="" novalidate class="auth-form">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="username-help" class="form-text">Enter your assigned DPWH username.</div>
                    </div>
